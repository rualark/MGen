...
Algorithm = 1001 # Id of the currently selected algorithm
Config = Short and fast # Name of configuration file for selected algorithm
MIDI_OUT = loopMIDI Port, MMSystem # Name of MIDI device used for playing notes
Horizontal_zoom = 200 # Zoom of the piano roll. Can be from 80 to 500
...
playback_speed = 200 # Playback speed in percent

...
# Legato adaptor
auto_legato = 1 # 1 = treat notes starting exactly at previous note ending as legato (and later nonlegato adaptor will convert some of them back to non-legato)

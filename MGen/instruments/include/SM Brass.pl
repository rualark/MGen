...
vib_sbell_top = 40-90 # Leftmost-rightmost maximum vibrato intensity in note (percent of note duration)
vibf_sbell_top = 30-90 # Leftmost-rightmost maximum vibrato speed in note (percent of note duration)

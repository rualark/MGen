...
\header {
  title = ""
  subtitle = "Multivoice Counterpoint Analysis: Erreurs TP04-mod (2019-02-08 23:48)"
  dedication = ""
}
...
\header {tagline = \markup \tiny \center-column {"This file was created by MGen CA3 v4.0-119-g9d69a40-dirty at 2019-02-08 23:48:57." #(string-append "Engraved by LilyPond " (lilypond-version) ". File: Erreurs TP04-mod")  " "}}
\markup { 
  \vspace #5
  \bold \tiny Legend:
} 

...
\header {
  title = ""
  subtitle = "Multivoice Counterpoint Analysis: Erreurs TP04-mod (2019-02-09 00:07)"
  dedication = ""
}
...
\header {tagline = \markup \tiny \center-column {"This file was created by MGen CA3 v4.0-124-g2145e3f-dirty at 2019-02-09 00:07:33." #(string-append "Engraved by LilyPond " (lilypond-version) ". File: Erreurs TP04-mod")  " "}}
\markup { 
  \vspace #5
  \bold \tiny Legend:
} 

...
Config = autoconf-MTE1110-TS01-Solu # Name of configuration file for selected algorithm
MIDI_OUT = [DISABLE PLAYBACK] # Name of MIDI device used for playing notes
Horizontal_zoom = 600 # Zoom of the piano roll. Can be from 1 to 2000
...
show_shift = 1 # Set to 1 to show shift near note start and ending

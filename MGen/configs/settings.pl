...
Config = window-scan # Name of configuration file for selected algorithm
...
View_timer = 300 # ms between each screen update during generation and playback. 100 ms is recommended. Increase for slower computers

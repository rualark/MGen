...
max_correct_ms = 9000000000 # Maximum time in milliseconds to correct using window-scan (set to 0 to scan up to the end)
...
emulate_sas = 1 # 0 = disable emulator, 1 = Enables SAS algorithm emulator

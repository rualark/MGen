...
max_correct_ms = 50000 # Maximum time in milliseconds to correct using window-scan (set to 0 to scan up to the end)
...
emulate_sas = 0 # 0 = disable emulator, 1 = Enables SAS algorithm emulator in CA2, 2 = shows full analysis before emulator

...
algorithm = rswa
c_len = 30 # Number of measures in each cantus. Usually 9 to 11
...
s_len = 8 # Maximum number of measures to full scan. 6-7 is recommended. Lower values can create less melodic results. Higher values are slow to compute

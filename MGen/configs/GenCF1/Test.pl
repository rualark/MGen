...
Late >4th resolution      = 0 # Leap greater than 4th is resolved after a second note
Late <5th resolution      = 0 # Leap smaller than 5th is resolved after a second note

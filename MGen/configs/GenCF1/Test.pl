...
"Prefilled unresolved 3rd" = 0 # 3rd is not resolved by backward movement, but it was filled before
"Unresolved 3rd"           = 0 # 3rd is not resolved by backward movement
"Preleaped unresolved 4th" = 0 # 4th is not resolved by backward movement, but it has a greater leap as neighbour
"Prefilled unresolved 4th" = 0 # 4th is not resolved by backward movement, but it was filled before
"Unresolved 4th"           = 0 # 4th is not resolved by backward movement
"Leap back overflow"       = 0 # Leap back is going farther than starting note of a previous leap
Preleaped unresolved >4th  = 0 # Leap longer than 4th is not resolved by backward movement, but it has a greater leap as neighbour
Prefilled unresolved >4th  = 0 # Leap longer than 4th is not resolved by backward movement, but it was filled before
"Prefilled unfilled 3rd"   = 0 # 3rd is not filled, but it was filled before
"Prefilled unfilled 4th"   = 0 # 4th is not filled, but it was filled before
"Prefilled unfilled >4th"  = 0 # Leap longer than 4th is not filled, but it was filled before
"Preleaped unfilled 4th"   = 0 # 4th is not filled, but it has a greater leap as neighbour
"Preleaped unfilled >4th"  = 0 # Leap longer than 4th is not filled, but it has a greater leap as neighbour
"Early-late filled 3rd"    = 0 # 3rd is not filled or prefilled, but it is filled somewhere else in the melody
"Early-late filled 4th"    = 0 # 4th is not filled or prefilled, but it is filled somewhere else in the melody
"Unfilled 3rd"             = 0 # 3rd is not filled
"Unfilled 4th"             = 0 # 4th is not filled
"Consecutive leaps"        = 0 # More than cse_leaps consecutive leaps
"Consecutive leaps+"       = 0 # More than cse_leaps2 consecutive leaps

...
"3rd to last is CEG"                 = X #SC! Third to last note is not Subdominant (C E G forbidden). Resetting this flag greatly decreases performance
Preleaped unfilled 3rd               = X #S 3rd is unfilled, but was prepared by leap before
Preleaped unresolved 3rd             = X #S! 3rd is unresolved, but was prepared by leap before
"Prefilled unresolved 3rd"           = X #S 3rd is not resolved by backward movement, but it was filled before
"Prefilled unfilled 3rd"             = X #S 3rd is not filled, but it was filled before
Late <6th resolution                 = X #S! Leap less than 6th is resolved after a second note
Leap back <7th                       = X #S Leap returns to same note (in case leap is equal or less than 4th)
Last leap                            = X #S Last step is a leap
Many leaps                           = X #S! Maximum allowed max_leaps during max_leap_steps
...
"Prefilled unresolved 4th"           = X #S 4th is not resolved by backward movement, but it was filled before
"Prefilled unfilled 4th"             = X #S 4th is not filled, but it was filled before
...
Outstanding repeat 2                 = 0 #U Prohibit repeating of 2 notes closer than repeat_steps2 between first notes (if beats are same)
Outstanding repeat 3                 = 0 #U Prohibit repeating of 3 notes closer than repeat_steps3 between first notes (if beats are same)
"Preleaped unfilled 4th"             = X #S 4th is not filled, but it has a greater leap as neighbour
"Preleaped unresolved 4th"           = X #U 4th is not resolved by backward movement, but it has a greater leap as neighbour
Prefilled unfilled >4th              = X #S Leap longer than 4th is not filled, but it was filled before
Prefilled unresolved >4th            = X #U Leap longer than 4th is not resolved by backward movement, but it was filled before
...
Long repeat                          = 0 #C 5 notes repeat within repeat_steps5
Long repeat+                         = 0 #C 7 notes repeat within repeat_steps7 
...
Unaltered VII before Im              = 0 #U Major second from VII up before Im
"Unaltered near altered (m)"         = 0 #U Unaltered VI or VII two adjacent steps near altered VI or VII

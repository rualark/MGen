...
"3rd to last is CEG"       = 1 #SC! Third to last note is not Subdominant (C E G forbidden). Resetting this flag greatly decreases performance
...
"First not C"              = 1 #C First note is not tonic
...
Late culmination           = 1 #L Culmination at last three steps

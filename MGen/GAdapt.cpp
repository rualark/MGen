...
void CGAdapt::AdaptMpercStep(int v, int x, int i, int ii, int ei, int pi, int pei)
{
	// Check lengroups
...
void CGAdapt::AdaptFriedlanderStep(int v, int x, int i, int ii, int ei, int pi, int pei)
{
	// Add slurs

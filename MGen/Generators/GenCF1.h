...
protected:
	...
	inline void FailLeapInit(int i, int & child_leap, int & prefilled, int & presecond, int & leap_next, int & leap_prev, int & arpeg, int & overflow, int & leap_size, int & leap_start, int & leap_end, vector<int>& leap);
	...
	inline int FailLeapFill(int i, int leap_prev, int leap_id, int leap_size, int leap_start, int leap_end, int preleap);
